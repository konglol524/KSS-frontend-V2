        ...
        <div className="flex justify-center h-screen bg-[#FFF2F9] ">
            <div className="relative mt-14">
                <div className="w-[1268px] h-[578px] bg-pink-200 rounded-lg bg-flower ">
                    ...
                    <div className="w-[373px] h-[73.19px] left-[818px] top-[39.41px] absolute"><span className="text-black text-5xl font-bold font-['Lato']">{promotionDetail.data.name}<br/></span><span className="text-black text-5xl font-normal font-['Lato']"><br/></span></div>
                    ...
                    <div className="w-[424px] h-[301px] left-[818px] top-[106px] absolute text-black text-[24px] font-normal font-['Lato']">Description: {matchedPromotion ? matchedPromotion.description : "No description available"} </div>
                    <div className="w-[424px] h-[301px] left-[818px] top-[140px] absolute text-black text-[24px] font-normal font-['Lato']">Rating: {promotionDetail.data.ratingSum}</div>
                </div>
            </div>
        </div>
    );
